...
const deleteSingleFileFromCloudinary = (public_id) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const response = yield axios_1.default.delete(`${environment_1.config.cloudinary.cloudinaryApi}/delete/single`, {
            data: { public_id },
        });
...
const deleteMultipleFileFromCloudinary = (public_ids) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const response = yield axios_1.default.delete(`${environment_1.config.cloudinary.cloudinaryApi}/delete/many`, {
            data: public_ids,
        });
