...
class JWT {
    constructor() {
        ...
        this.generateAccessToken = (payload) => __awaiter(this, void 0, void 0, function* () {
            return this.signToken(payload, environment_1.config.jwt.accessTokenSecret, environment_1.config.jwt.accessTokenExpired);
        });
        this.generateRefreshToken = (payload) => __awaiter(this, void 0, void 0, function* () {
            return this.signToken(payload, environment_1.config.jwt.refreshTokenSecret, environment_1.config.jwt.refreshTokenExpired);
        });
        this.verifyToken = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const { talktiveAccessToken: accessToken, talktiveRefreshToken: refreshToken, } = req.cookies;
            try {
                const user = jsonwebtoken_1.default.verify(accessToken, environment_1.config.jwt.accessTokenSecret);
                req.id = user.id;
        ...
        this.handleExpiredAccessToken = (refreshToken, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = jsonwebtoken_1.default.verify(refreshToken, environment_1.config.jwt.refreshTokenSecret);
                ...
                cookie_1.cookieManager.setTokens(res, newAccessToken, newRefreshToken);
                const user = yield user_service_1.UserService.findUserById(payload === null || payload === void 0 ? void 0 : payload.id);
