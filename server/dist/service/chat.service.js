...
const getCloudinaryFilePublicIdFromUrl_1 = __importDefault(
  require("../utils/getCloudinaryFilePublicIdFromUrl")
);
...
class Service {
  lastMessageSanitizer(message) {
    return {
      id:
        (message === null || message === void 0 ? void 0 : message._id) &&
        String(message === null || message === void 0 ? void 0 : message._id),
  ...
  chatSanitizer(chat) {
    var _a;
    const participants =
      (_a = chat === null || chat === void 0 ? void 0 : chat.participants) ===
        null || _a === void 0
        ? void 0
        : _a.map((user) => user_service_1.UserService.userSanitizer(user));
    const admin = user_service_1.UserService.userSanitizer(
      chat === null || chat === void 0 ? void 0 : chat.admin
    );
    const lastMessage = this.lastMessageSanitizer(
      chat === null || chat === void 0 ? void 0 : chat.lastMessage
    );
    return {
      id:
      ...
      groupDescription:
        chat === null || chat === void 0 ? void 0 : chat.groupDescription,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!isExist) {
        ...
        if (isExist.groupImage) {
          const publicId = (0, getCloudinaryFilePublicIdFromUrl_1.default)(
            isExist === null || isExist === void 0 ? void 0 : isExist.groupImage
          );
          if (publicId) {
            yield (0,
            deletePreviousFileFromCloudinary_1.deleteSingleFileFromCloudinary)(
              publicId
            );
          }
        }
      ...
      if (imageLink) {
        ...
        if (!chat) {
          ...
          if (chat === null || chat === void 0 ? void 0 : chat.groupImage) {
            const publicId = (0, getCloudinaryFilePublicIdFromUrl_1.default)(
              chat === null || chat === void 0 ? void 0 : chat.groupImage
            );
            if (publicId) {
              yield (0,
              deletePreviousFileFromCloudinary_1.deleteSingleFileFromCloudinary)(
